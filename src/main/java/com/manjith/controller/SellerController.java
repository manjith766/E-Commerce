...
public class SellerController {
    ...
    public ResponseEntity<Seller>createSeller(@RequestBody Seller seller)throws Exception, MessagingException {
        ...
        String subject = "Ecommerce bazaar verification code";
        String text = "welcome to Ecommerce bazaar, verify your account using this link ";
...
//    }
    ...
    public ResponseEntity<Seller>updateSeller(@RequestHeader("Authorization")String jwt,@RequestBody Seller seller)throws Exception{
        Seller profile = sellerService.getsSellerProfile(jwt);
